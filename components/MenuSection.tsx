        ...
        <div className="sticky top-[68px] z-30 bg-brand-green-dark backdrop-blur-md pt-3.5 pb-3.5 border-b border-brand-gold/10 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 max-w-7xl mx-auto">
            ...
            <div className="flex bg-white/5 p-1.5 rounded-full border border-white/10 self-center md:self-auto shrink-0 shadow-inner">
              ...
              >
                <span className="w-2.5 h-2.5 rounded-full bg-green-500 block border border-white" />
                Veg
              </button>
              <button
              ...
              >
                <span className="w-2.5 h-2.5 rounded-full bg-brand-red block border border-white" />
                Non-Veg
              </button>
            </div>
          ...
          <div
            ...
            className="flex items-center gap-3 overflow-x-auto no-scrollbar py-2.5 mt-3 -mx-4 px-4 scroll-smooth"
          >
