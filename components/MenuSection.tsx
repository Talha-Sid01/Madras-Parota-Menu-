  ...
  return (
    <section id="menu" className="py-16 md:py-24 bg-brand-green text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sticky top-[68px] z-30 bg-brand-green-dark backdrop-blur-md pt-2.5 pb-2.5 border-b border-brand-gold/10 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3.5 max-w-7xl mx-auto">
            ...
            <div className="flex bg-white/5 p-1 rounded-full border border-white/10 self-center md:self-auto shrink-0 shadow-inner">
              <button
                ...
                className={`px-4 py-1.5 rounded-full font-body text-xs font-bold transition-all duration-200 cursor-pointer ${
                  filterType === 'all'
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full font-body text-xs font-bold transition-all duration-200 flex items-center gap-1 cursor-pointer ${
                  filterType === 'veg'
            ...
            <div className="relative w-full md:max-w-xs shadow-inner rounded-full overflow-hidden border border-white/10 hover:border-brand-gold/30 focus-within:border-brand-gold/50 transition-all duration-300 bg-white/5">
              ...
              <input
                ...
                className="w-full pl-11 pr-5 py-2 bg-transparent font-body text-xs sm:text-sm outline-none text-white placeholder-white/40"
          ...
          >
            {filteredMenu.map((category) => (
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border text-[11px] font-bold whitespace-nowrap transition-all duration-300 shrink-0 cursor-pointer ${
