        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="mt-4">
              ...
              {/* EDITING INSTRUCTION: Adjust hours value below if restaurant operations change */}
          ...
          <div className="md:col-span-3 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              {/* TODO: Owner must replace '#' below with their actual Instagram page link when launched */}
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
